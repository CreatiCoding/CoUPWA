...
initialState.contentsSwiper.on('slideChange', function() {
    $('.main-contents-dow-btn')[initialState.curWeekDay].className = $('.main-contents-dow-btn')[
        initialState.curWeekDay
    ].className.replace('clicked', 'unclcked');
    $('.main-contents-dow-btn')[initialState.contentsSwiper.activeIndex].className = $('.main-contents-dow-btn')[
